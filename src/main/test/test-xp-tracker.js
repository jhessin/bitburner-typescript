...
export async function main(ns) {
  ...
  while (true) {
    ...
    ns.print(
      `${ns.nFormat(xpTenSec, '0,000.000a')} last 10 seconds, ${ns.nFormat(
        xpSec,
        '0,000.000a',
      )} / sec (total ${ns.nFormat(xpSecTot, '0,000.000a')} / sec)`,
    );
    ...
    if (countTenSec % 6 === 0) {
      ...
      let xs = xp / 60;
      ns.print(
        `${ns.nFormat(xp, '0,000.000a')} last minute, ${ns.nFormat(
          xs,
          '0,000.000a',
        )} / sec`,
      );
    ...
    if (countTenSec % 360 === 0) {
      ...
      let xs = xp / 3600;
      ns.print(
        `${ns.nFormat(xp, '0,000.000a')} last hour, ${ns.nFormat(
          xs,
          '0,000.000a',
        )} / sec`,
      );
