...
const scriptSolver = getFilePath('/sample/contractor.js.solver.js');
...
export async function main(ns) {
  ...
  let dictContractData = await contractsDictCommand(
    'ns.codingcontract.getData(c.contract, c.hostname)',
  ...
  ns.run(
    getFilePath('/sample/run-with-delay.js'),
    1,
    scriptSolver,
    1,
