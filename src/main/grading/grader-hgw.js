...
// --- CONFIG SECTION ---
const testFile = '/tools/batcher-hgw.js'; // File to run to initiate testing
const testTimeLimit = 3600000; // Graded time, 30 min + 1/2 weaken time to compare with my hour run
const testFileArgs = []; // (not used, batcher-hgw will select a target and run on current computer
const host = null;
// --- END CONFIG SECTION ---
